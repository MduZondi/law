...
# Initialize the ChatAnthropic model only if the API key is provided
if anthropic_api_key:
    llm = ChatAnthropic(model="claude-3-sonnet-20240229", anthropic_api_key=anthropic_api_key, streaming=True)
else:
